...
- Name: login.spec.ts >> 登录流程 >> 错误凭据显示错误提示
...
Locator: locator('.ant-message-error, .ant-notification-error, .ant-alert-error')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('.ant-message-error, .ant-notification-error, .ant-alert-error')
