...
const patternRevisionService = {
   ...
   */
  submit(id: string) {
    return api.post<PatternRevision>(`${PATTERN_REVISION_API}/${id}/submit`);
  },
   ...
   */
  approve(id: string) {
    return api.post<PatternRevision>(`${PATTERN_REVISION_API}/${id}/approve`);
  },
  ...
  reject(id: string, comment: string) {
    return api.post<PatternRevision>(`${PATTERN_REVISION_API}/${id}/reject`, { comment });
  },
   ...
   */
  complete(id: string) {
    return api.post<PatternRevision>(`${PATTERN_REVISION_API}/${id}/complete`);
  },
