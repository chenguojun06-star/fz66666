  ...
  return (
    ...
    >
      ...
      >
        {file ? (
          <div>
            <p className="u-fw-500" style={{ color: 'var(--primary-color)' }}>{file.name}</p>
          ...
          <>
            ...
            <p className="u-fs-var--font-size-xs" style={{ color: 'var(--neutral-text-secondary)' }}>
              支持 JPG / PNG / WEBP / PDF
            </p>
          </>
        )}
      ...
      {error && (
        <div className="u-mt-8 u-fs-var--font-size-xs" style={{ color: 'var(--error-color, var(--color-danger))' }}>
          {error}
        </div>
      )}
      {text && (
