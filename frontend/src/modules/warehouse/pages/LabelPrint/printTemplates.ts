...
.tag::before{content:'';position:absolute;inset:0;border:1.2pt solid #27272a;pointer-events:none}
.tag::after{content:'';position:absolute;inset:1.6mm;border:0.4pt solid #999999;pointer-events:none}
...
.brand-name{font-size:${ts}pt;font-weight:800;letter-spacing:2.5mm;color:#000000;line-height:1.3}
.brand-line{width:60%;height:0;border-top:0.8pt solid #27272a;margin:1.8mm auto 0}
.brand-line::after{content:'';display:block;width:30%;height:0;border-top:0.4pt solid #999999;margin:0.8mm auto 0}
.info{flex:1;display:flex;flex-direction:column;justify-content:flex-start}
.row{display:flex;align-items:baseline;padding:0.7mm 0;border-bottom:0.2pt solid #f0f0f0;font-size:${isz}pt;line-height:1.5}
.row:last-child{border-bottom:none}
.lbl{color:#888888;min-width:13mm;white-space:nowrap;font-weight:400;flex-shrink:0}
.val{font-weight:600;color:#1a1a1a;flex:1;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.cert-box{margin-top:auto;border:0.6pt solid #52525b;padding:1.5mm 2.5mm;position:relative}
.cert-title{font-size:${isz + 0.5}pt;font-weight:700;text-align:center;letter-spacing:2mm;color:#27272a;margin-bottom:1mm;padding-bottom:0.8mm;border-bottom:0.3pt solid #bfbfbf}
.cert-row{display:flex;align-items:baseline;font-size:${isz - 0.3}pt;padding:0.3mm 0}
.cert-lbl{color:#888888;min-width:13mm}
.cert-val{font-weight:600;color:#27272a}
.bottom-bar{display:flex;justify-content:space-between;align-items:flex-end;padding-top:1.5mm;margin-top:1.5mm;border-top:0.3pt solid #d4d4d8}
.ucode{font-size:${isz - 0.5}pt;color:#888888;letter-spacing:0.3mm}
.price{font-size:${ts * 1.15}pt;font-weight:800;color:#ef4444;letter-spacing:0.5mm}
