...
export const imageColumn = {
  ...
  render: (v: string) => v ? <Image src={getFullAuthedFileUrl(v)} width={40} height={40} className="u-objf-cover u-br-4" fallback="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mN88P/BfwAJhAPk2iMa1AAAAABJRU5ErkJggg==" /> : <div className="u-br-4 u-d-flex u-ai-center u-jc-center u-fs-14" style={{ width: 40, height: 40, background: 'var(--color-bg-subtle)', color: 'var(--color-text-quaternary)' }}>无</div>,
};
