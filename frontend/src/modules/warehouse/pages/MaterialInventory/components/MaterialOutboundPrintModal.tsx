  ...
  return `
    ...
    <html lang="zh-CN">
      <head>
        ...
        <title>面辅料出库单</title>
        <style>
          body { font-family: system-ui, -apple-system, BlinkMacSystemFont, "'Segoe UI'", Roboto, "'Helvetica Neue'", Arial, "'Noto Sans'", "'Microsoft YaHei'", "'PingFang SC'", serif; color: var(--color-black); padding: 20px; }
          ...
          .meta-label { color: var(--color-gray-dark); display: inline-block; min-width: 88px; }
          table { width: 100%; border-collapse: collapse; margin-top: 12px; }
          th, td { border: 1px solid var(--color-black); padding: 6px 8px; font-size: 12px; text-align: left; }
          ...
          .signature { width: 28%; border-top: 1px solid var(--color-black); padding-top: 8px; text-align: center; }
          @media print {
            body { padding: 0; }
