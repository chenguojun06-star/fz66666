      ...
      <body>
        <div class="page">
          ...
          <div class="meta">
            ...
            <div class="meta-item"><span class="meta-label">颜色/规格</span>${data.color || '-'} / ${data.specification || '-'}</div>
      ...
      {!data ? (
        ...
        <div style={{ padding: '8px 0' }}>
          ...
          >
            ...
            <div><strong>颜色/规格：</strong>{`${data.color || '-'} / ${data.specification || '-'}`}</div>
