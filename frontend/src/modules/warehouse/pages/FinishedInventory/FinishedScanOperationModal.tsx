  ...
  return (
    ...
    >
      <Space orientation="vertical" style={{ width: '100%' }} size={16}>
        ...
        <div>
          <div className="u-mb-4 u-fs-14" style={{ color: 'var(--color-text-tertiary)' }}>扫码/输入商品编码</div>
        ...
        {scanResult && !scanResult.found && (
          <Card style={{ background: 'var(--status-warning-bg)', border: '1px solid var(--status-warning-border)' }}>
            <div className="u-mb-8 u-fw-600" style={{ color: 'var(--color-warning)' }}> 商品编码不存在，入库时将自动创建</div>
            <Row gutter={12}>
              <Col span={8}>
                <div className="u-mb-4 u-fs-14" style={{ color: 'var(--color-text-tertiary)' }}>款号</div>
                <Input value={styleNo} onChange={e => setStyleNo(e.target.value)} placeholder="款号" />
              </Col>
              <Col span={8}>
                <div className="u-mb-4 u-fs-14" style={{ color: 'var(--color-text-tertiary)' }}>颜色</div>
                <Input value={color} onChange={e => setColor(e.target.value)} placeholder="颜色" />
              </Col>
              <Col span={8}>
                <div className="u-mb-4 u-fs-14" style={{ color: 'var(--color-text-tertiary)' }}>尺码</div>
        ...
        <div>
          <div className="u-mb-4 u-fs-14" style={{ color: 'var(--color-text-tertiary)' }}>备注</div>
