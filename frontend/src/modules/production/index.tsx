...
export type { MaterialPurchaseDetailProps } from './pages/Production/MaterialPurchaseDetail';
...
export type { InspectionDetailProps } from './pages/Production/ProductWarehousing/pages/InspectionDetail';
