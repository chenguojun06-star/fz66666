...
export const brandTitleStyle: React.CSSProperties = { fontSize: 15, fontWeight: 700, color: 'var(--color-slate-900)' };
export const brandSubtitleStyle: React.CSSProperties = { fontSize: 13, color: 'var(--color-text-tertiary)', marginTop: 2 };
export const statusTagStyle: React.CSSProperties = { marginInlineEnd: 0, padding: '6px 14px', borderRadius: 999, fontWeight: 700 };
export const orderNoStyle: React.CSSProperties = { fontSize: 18, fontWeight: 800, color: 'var(--color-slate-900)', marginBottom: 8 };
...
export const summaryCaptionStyle: React.CSSProperties = { fontSize: 13, color: 'var(--color-text-tertiary)', marginBottom: 8 };
export const currentStageStyle: React.CSSProperties = { fontSize: 16, fontWeight: 800, color: 'var(--color-slate-900)', marginBottom: 8 };
export const summaryTextStyle: React.CSSProperties = { fontSize: 14, color: 'var(--color-text-tertiary)', lineHeight: 1.7 };
...
export const sizeQtyFooterStyle: React.CSSProperties = {
  ...
  fontSize: 14, fontWeight: 600, color: 'var(--color-slate-700)',
};
...
export const progressSummaryTitleStyle: React.CSSProperties = { fontSize: 15, fontWeight: 700, color: 'var(--color-primary-dark)' };
export const progressSummaryMetaStyle: React.CSSProperties = { fontSize: 14, color: 'var(--color-text-tertiary)' };
...
export const panelTitleStyle: React.CSSProperties = { fontSize: 15, fontWeight: 800, color: 'var(--color-slate-900)', marginBottom: 16 };
...
export const aiSupportTextStyle: React.CSSProperties = { marginTop: 6, fontSize: 14, color: 'var(--color-text-tertiary)', lineHeight: 1.5 };
export const confidenceStyle: React.CSSProperties = { fontSize: 14, fontWeight: 700, color: 'var(--color-slate-900)', background: 'rgba(241,245,249,0.9)', borderRadius: 999, padding: '8px 12px' };
...
export const remarkTextStyle: React.CSSProperties = { fontSize: 15, color: 'var(--color-slate-900)', lineHeight: 1.8, whiteSpace: 'pre-wrap' };
...
export const timelineDotStyle: React.CSSProperties = { width: 10, height: 10, borderRadius: 999, background: 'var(--color-primary-dark)', marginTop: 7, boxShadow: '0 0 0 4px rgba(59,130,246,0.14)' };
export const emptyPanelStyle: React.CSSProperties = { fontSize: 14, color: 'var(--color-text-tertiary)', lineHeight: 1.7 };
export const bottomBrandLineStyle: React.CSSProperties = { display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: 14, padding: '4px 6px 0', fontSize: 13, color: 'var(--color-text-tertiary)' };
