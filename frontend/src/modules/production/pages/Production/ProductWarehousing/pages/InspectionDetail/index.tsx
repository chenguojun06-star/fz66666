  ...
  const renderQcRecords = () => (
    <div>
      ...
      <Row gutter={16} style={{ marginBottom: 16 }}>
        ...
        <Col span={4}><Statistic title="合格数" value={qcStats.qualified} valueStyle={{ color: '#52c41a' }} /></Col>
        <Col span={4}><Statistic title="不合格数" value={qcStats.unqualified} valueStyle={{ color: '#ff4d4f' }} /></Col>
        <Col span={4}><Statistic title="已入库" value={qcStats.warehoused} valueStyle={{ color: '#1677ff' }} /></Col>
        <Col span={4}><Statistic title="待入库" value={qcStats.pendingWarehouse} valueStyle={{ color: '#faad14' }} /></Col>
      </Row>
        ...
        <Table<WarehousingDetailRecord>
          ...
          columns={[
            ...
            },
            {
              ...
              render: (v: number) => v ? <span style={{ color: '#ff4d4f' }}>{v}</span> : <span>0</span>,
            },
            {
            ...
            <Card size="small" title="款式信息">
              <div style={{ textAlign: 'center', marginBottom: 12 }}>
                {(style?.cover || order?.styleCover) ? (
                  <Image
                    src={style?.cover || order?.styleCover} alt={order.styleName}
