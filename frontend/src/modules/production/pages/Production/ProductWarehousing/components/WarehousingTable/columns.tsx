...
import { printWarehousingQr, getUrgencyTag, getPlateTypeTag } from './helpers';
...
export function buildColumns({ goToDetail, isOrderFrozen, dataSource }: BuildColumnsParams) {
  const columns = [
    {
      title: '图片',
      key: 'cover',
