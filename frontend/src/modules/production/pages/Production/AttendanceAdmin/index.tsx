    ...
    >
      <Form form={form} layout="vertical" preserve={false}>
        ...
        <Form.Item name="remark" label="备注">
          <Input.TextArea rows={2} placeholder="补录原因（可选）" maxLength={200} showCount />
        </Form.Item>
  ...
  return (
    ...
    >
      <Form form={form} layout="vertical" preserve={false}>
        ...
        <Form.Item name="remark" label="备注">
          <Input.TextArea rows={2} placeholder="修改原因（可选）" maxLength={200} showCount />
        </Form.Item>
      </Form>
    </StandardModal>
  );
  ...
  return (
    ...
    >
      <Form form={form} layout="vertical" preserve={false}>
        ...
        <Form.Item name="remark" label="备注">
          <Input.TextArea rows={2} placeholder="休假说明（可选）" maxLength={200} showCount />
        </Form.Item>
        <div style={{ color: 'var(--color-text-tertiary)', fontSize: 12 }}>
