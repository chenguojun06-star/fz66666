...
export function useMaterialPurchase() {
  ...
  return {
    ...
    confirmCompleteModalOpen: actions.confirmCompleteModalOpen,
    closeConfirmCompleteModal: actions.closeConfirmCompleteModal,
    submitConfirmComplete: actions.submitConfirmComplete,
    confirmCompleteTargets: actions.confirmCompleteTargets,
