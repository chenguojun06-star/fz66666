// 节点解析内部工具函数与常量
// 从 nodeResolution.ts 拆分而来，包含常量、工艺码排序、数值工具、子工艺重映射

import { ProductionOrder } from '@/types/production';
import { ProgressNode } from '../types';
import { canonicalStageKey } from './stageMapping';
import type { SubProcessRemap } from './nodeResolution.types';
...
// ===== 子工艺重映射 =====
export const stageKeyToParent = (stageKey: string) => {
