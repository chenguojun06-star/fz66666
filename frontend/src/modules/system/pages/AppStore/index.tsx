      ...
      <ResizableModal title={<div style={{ display: 'flex', alignItems: 'center', gap: 8 }}><span style={{ fontSize: 15 }}>{selectedApp?.appIcon}</span><span style={{ fontSize: 15 }}>{selectedApp?.appName}</span>{isAppActivated(selectedApp?.appCode || '') && <Tag color="green">已开通</Tag>}</div>}
        ...
        <div style={{ padding: '8px 0' }}>
          ...
          {parseFeatures(selectedApp?.features).length > 0 && (
            <div style={{ marginBottom: 12 }}><div style={{ fontSize: 14, fontWeight: 600, marginBottom: 4, borderLeft: '3px solid var(--primary-color, var(--color-info))', paddingLeft: 8 }}>核心功能</div>
          ...
          <div>
            <div style={{ fontSize: 14, fontWeight: 600, marginBottom: 10, borderLeft: '3px solid var(--primary-color, var(--color-info))', paddingLeft: 8 }}>价格方案</div>
            <div style={{ display: 'grid', gridTemplateColumns: selectedApp?.trialDays ? 'repeat(4, 1fr)' : 'repeat(3, 1fr)', gap: 10 }}>
              {selectedApp?.trialDays ? (<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '12px 6px', borderRadius: 10, border: '1.5px solid var(--color-success)', background: 'linear-gradient(135deg, var(--status-success-bg) 0%, #d9f7be 100%)', minHeight: 88 }}><GiftOutlined style={{ fontSize: 15, color: 'var(--color-success)', marginBottom: 4 }} /><div style={{ fontSize: 14, color: '#389e0d', fontWeight: 600, marginBottom: 3 }}>免费试用</div><div style={{ fontSize: 13, fontWeight: 700, color: 'var(--color-success)', lineHeight: 1.2 }}>¥0</div><div style={{ fontSize: 14, color: '#73d13d', marginTop: 3 }}>{selectedApp.trialDays} 天</div></div>) : null}
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '12px 6px', borderRadius: 10, border: '1.5px solid var(--color-border-antd)', background: 'var(--color-bg-container)', minHeight: 88 }}><div style={{ fontSize: 14, color: 'var(--color-text-tertiary)', fontWeight: 500, marginBottom: 4 }}>月 付</div><div style={{ fontSize: 13, fontWeight: 700, color: 'var(--color-primary)', lineHeight: 1.2 }}>¥{selectedApp?.priceMonthly}</div><div style={{ fontSize: 14, color: 'var(--color-text-quaternary)', marginTop: 3 }}>/ 月</div></div>
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '12px 6px', borderRadius: 10, border: '1.5px solid var(--color-warning)', background: 'linear-gradient(135deg, #FFFBE6 0%, #E6F4FF 100%)', minHeight: 88, position: 'relative' }}><div style={{ position: 'absolute', top: -1, right: -1, background: 'var(--color-warning)', color: 'var(--color-bg-base)', fontSize: 9, fontWeight: 700, padding: '1px 6px', borderRadius: '0 9px 0 8px', letterSpacing: 0.5 }}>推荐</div><div style={{ fontSize: 14, color: '#d48806', fontWeight: 600, marginBottom: 4 }}>年 付</div><div style={{ fontSize: 13, fontWeight: 700, color: 'var(--color-warning)', lineHeight: 1.2 }}>¥{selectedApp?.priceYearly}</div><div style={{ fontSize: 9, color: '#ffc53d', marginTop: 3 }}>/ 年 · 省2个月</div></div>
