        ...
        <div className="u-p-8px0">
          ...
          <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: selectedApp?.trialDays ? 'repeat(4, 1fr)' : 'repeat(3, 1fr)', gap: 10 }}>
              {selectedApp?.trialDays ? (<div className="u-d-flex u-fd-column u-ai-center u-jc-center u-br-10" style={{ padding: '12px 6px', border: '1.5px solid var(--color-success)', background: 'linear-gradient(135deg, var(--status-success-bg) 0%, #d9f7be 100%)', minHeight: 88 }}><GiftOutlined style={{ fontSize: 15, color: 'var(--color-success)', marginBottom: 4 }} /><div className="u-fs-14 u-fw-600" style={{ color: '#389e0d', marginBottom: 3 }}>免费试用</div><div className="u-fs-13 u-fw-700" style={{ color: 'var(--color-success)', lineHeight: 1.2 }}>¥0</div><div className="u-fs-14" style={{ color: '#73d13d', marginTop: 3 }}>{selectedApp.trialDays} 天</div></div>) : null}
