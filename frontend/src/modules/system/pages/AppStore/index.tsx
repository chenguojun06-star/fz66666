        ...
        <div style={{ padding: '8px 0' }}>
          ...
          <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: selectedApp?.trialDays ? 'repeat(4, 1fr)' : 'repeat(3, 1fr)', gap: 10 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '12px 6px', borderRadius: 10, border: '1.5px solid #d9d9d9', background: '#fafafa', minHeight: 88 }}><div style={{ fontSize: 14, color: '#8c8c8c', fontWeight: 500, marginBottom: 4 }}>月 付</div><div style={{ fontSize: 13, fontWeight: 700, color: '#1677ff', lineHeight: 1.2 }}>¥{selectedApp?.priceMonthly}</div><div style={{ fontSize: 14, color: '#bfbfbf', marginTop: 3 }}>/ 月</div></div>
