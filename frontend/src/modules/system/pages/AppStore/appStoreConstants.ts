...
export const MODULE_CONFIG: Record<string, { icon: string; color: string; urlHint: string }> = {
  ...
  EC_TAOBAO:      { icon: '', color: 'var(--color-orange-500)', urlHint: '如: https://your-system.com/webhook/taobao' },
  EC_TMALL:       { icon: '', color: 'var(--color-red-700)', urlHint: '如: https://your-system.com/webhook/tmall' },
  EC_JD:          { icon: '', color: 'var(--color-red-600)', urlHint: '如: https://your-system.com/webhook/jd' },
  EC_DOUYIN:      { icon: '', color: 'var(--color-dark-bg)', urlHint: '如: https://your-system.com/webhook/douyin' },
  EC_PINDUODUO:   { icon: '', color: 'var(--color-red-600)', urlHint: '如: https://your-system.com/webhook/pdd' },
  EC_XIAOHONGSHU: { icon: '', color: 'var(--color-red-500)', urlHint: '如: https://your-system.com/webhook/xiaohongshu' },
  EC_WECHAT_SHOP: { icon: '', color: 'var(--color-emerald-500)', urlHint: '如: https://your-system.com/webhook/wechat-shop' },
  EC_SHOPIFY:     { icon: '', color: 'var(--color-primary)', urlHint: '如: https://your-system.com/webhook/shopify' },
  EC_JST:      { icon: '', color: 'var(--color-orange-600)', urlHint: '如: https://your-system.com/webhook/jst' },
  EC_SHEIN:    { icon: '', color: 'var(--color-coral)', urlHint: '如: https://your-system.com/webhook/shein' },
