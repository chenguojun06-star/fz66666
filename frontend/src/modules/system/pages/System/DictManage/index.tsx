...
const DICT_TYPES = [
  ...
  { value: 'material_category', label: '物料分类', description: '面料、里料、辅料分类' },
  ...
  { value: 'process_name', label: '工序名称', description: '具体工序名：做领、上袖、做侧缝等' },
  { value: 'process_difficulty', label: '工序难度', description: '工序难度等级：易、中、难' },
  { value: 'machine_type', label: '机器类型', description: '生产设备：平车、四线锁边、双针车等' },
  { value: 'process_description', label: '工序描述', description: '工序操作描述说明' },
  { value: 'progress_stage', label: '进度节点', description: '6大父进度：采购、裁剪、二次工艺、车缝、尾部、入库' },
  { value: 'craft_type', label: '工艺类型', description: '刺绣、印花、水洗、染色等' },
  { value: 'factory_type', label: '工厂类型', description: '工厂类别：面辅料供应商、外发供应商' },
  { value: 'factory_label', label: '内外标签', description: '内部工厂（工资结算）、外部工厂（订单结算）' },
  { value: 'quality_level', label: '质量等级', description: '质检等级：优、良、合格、不合格' },
  { value: 'defect_type', label: '瑕疵类型', description: '常见瑕疵：色差、破损、污渍等' },
  { value: 'review_status', label: '审核状态', description: '样衣审核：通过、需修改、不通过' },
  { value: 'secondary_process_status', label: '二次工艺状态', description: '待处理、处理中、已完成、已取消' },
  { value: 'employment_status', label: '用工状态', description: '正式、试用期、临时工' },
  { value: 'package_type', label: '包装方式', description: '包装类型：吊挂、平放、卷装等' },
  { value: 'order_status', label: '订单状态', description: '订单流程状态' },
  { value: 'order_type', label: '首翻单', description: '首单、翻单' },
  { value: 'order_biz_type', label: '下单类型', description: 'FOB、ODM、OEM、CMT' },
  { value: 'urgency_level', label: '紧急程度', description: '订单优先级：加急、普通' },
  { value: 'outbound_type', label: '出库类型', description: '销售出库、调拨出库、报废出库' },
  { value: 'payment_method', label: '结算方式', description: '付款方式：月结、现结等' },
  { value: 'template_type', label: '模板类型', description: '工序进度单价、多码工序进度单价' },
  { value: 'warehouse_location', label: '仓库', description: '仓库库位：A仓、B仓、成品仓、面辅料仓等' },
  { value: 'garment_part', label: '服装部位', description: '面料部位：整件、上装、下装、马甲、里布、其他' },
...
const DictManage: React.FC = () => {
  ...
  const getLocalData = (dictType: string): DictItem[] => {
    const data: Record<string, DictItem[]> = {
      ...
      process_name: [
        { dictType: 'process_name', dictCode: 'COLLAR', dictLabel: '做领', sort: 1 },
        { dictType: 'process_name', dictCode: 'SLEEVE', dictLabel: '上袖', sort: 2 },
        { dictType: 'process_name', dictCode: 'SIDE_SEAM', dictLabel: '做侧缝', sort: 3 },
        { dictType: 'process_name', dictCode: 'CUFF', dictLabel: '做袖口', sort: 4 },
        { dictType: 'process_name', dictCode: 'HEM', dictLabel: '做下摆', sort: 5 },
        { dictType: 'process_name', dictCode: 'POCKET', dictLabel: '做口袋', sort: 6 },
        { dictType: 'process_name', dictCode: 'ZIPPER', dictLabel: '上拉链', sort: 7 },
        { dictType: 'process_name', dictCode: 'BUTTONHOLE', dictLabel: '锁扣眼', sort: 8 },
        { dictType: 'process_name', dictCode: 'IRONING', dictLabel: '烫整', sort: 9 },
        { dictType: 'process_name', dictCode: 'QC', dictLabel: '质检', sort: 10 },
      ],
      machine_type: [
        { dictType: 'machine_type', dictCode: 'FLAT', dictLabel: '平车', sort: 1 },
        { dictType: 'machine_type', dictCode: 'OVERLOCK_4', dictLabel: '四线锁边', sort: 2 },
        { dictType: 'machine_type', dictCode: 'OVERLOCK_5', dictLabel: '五线锁边', sort: 3 },
        { dictType: 'machine_type', dictCode: 'DOUBLE_NEEDLE', dictLabel: '双针车', sort: 4 },
        { dictType: 'machine_type', dictCode: 'BUTTONHOLE_M', dictLabel: '锁眼车', sort: 5 },
        { dictType: 'machine_type', dictCode: 'BUTTON_M', dictLabel: '钉扣车', sort: 6 },
        { dictType: 'machine_type', dictCode: 'BARTACK', dictLabel: '打枣车', sort: 7 },
        { dictType: 'machine_type', dictCode: 'ZIGZAG', dictLabel: '人字车', sort: 8 },
        { dictType: 'machine_type', dictCode: 'COVER_STITCH', dictLabel: '冚车', sort: 9 },
        { dictType: 'machine_type', dictCode: 'CUTTING_M', dictLabel: '裁床', sort: 10 },
        { dictType: 'machine_type', dictCode: 'IRON_M', dictLabel: '烫台', sort: 11 },
      ],
      process_description: [
        { dictType: 'process_description', dictCode: 'SEW_DESC', dictLabel: '车缝', sort: 1 },
        { dictType: 'process_description', dictCode: 'CUT_DESC', dictLabel: '裁剪', sort: 2 },
        { dictType: 'process_description', dictCode: 'IRON_DESC', dictLabel: '整烫', sort: 3 },
        { dictType: 'process_description', dictCode: 'INSPECT_DESC', dictLabel: '检验', sort: 4 },
        { dictType: 'process_description', dictCode: 'PACK_DESC', dictLabel: '包装', sort: 5 },
      ],
      garment_part: [
        { dictType: 'garment_part', dictCode: 'GARMENT_PART_WHOLE', dictLabel: '整件', sort: 1 },
        { dictType: 'garment_part', dictCode: 'GARMENT_PART_UPPER', dictLabel: '上装', sort: 2 },
        { dictType: 'garment_part', dictCode: 'GARMENT_PART_VEST', dictLabel: '马甲', sort: 3 },
        { dictType: 'garment_part', dictCode: 'GARMENT_PART_LOWER', dictLabel: '下装', sort: 4 },
        { dictType: 'garment_part', dictCode: 'GARMENT_PART_LINING', dictLabel: '里布', sort: 5 },
        { dictType: 'garment_part', dictCode: 'GARMENT_PART_OTHER', dictLabel: '其他', sort: 6 },
      ],
      process_difficulty: [
        { dictType: 'process_difficulty', dictCode: 'EASY', dictLabel: '易', sort: 1 },
        { dictType: 'process_difficulty', dictCode: 'MEDIUM', dictLabel: '中', sort: 2 },
        { dictType: 'process_difficulty', dictCode: 'HARD', dictLabel: '难', sort: 3 },
      ],
      material_category: [
        { dictType: 'material_category', dictCode: 'FABRIC', dictLabel: '面料', sort: 1 },
        { dictType: 'material_category', dictCode: 'LINING', dictLabel: '里料', sort: 2 },
        { dictType: 'material_category', dictCode: 'ACCESSORY', dictLabel: '辅料', sort: 3 },
      ],
      progress_stage: [
        { dictType: 'progress_stage', dictCode: 'PURCHASE', dictLabel: '采购', sort: 1 },
        { dictType: 'progress_stage', dictCode: 'CUTTING', dictLabel: '裁剪', sort: 2 },
        { dictType: 'progress_stage', dictCode: 'SECONDARY', dictLabel: '二次工艺', sort: 3 },
        { dictType: 'progress_stage', dictCode: 'SEWING', dictLabel: '车缝', sort: 4 },
        { dictType: 'progress_stage', dictCode: 'FINISHING', dictLabel: '尾部', sort: 5 },
        { dictType: 'progress_stage', dictCode: 'WAREHOUSING', dictLabel: '入库', sort: 6 },
      ],
      factory_label: [
        { dictType: 'factory_label', dictCode: 'INTERNAL', dictLabel: '内部工厂', sort: 1 },
        { dictType: 'factory_label', dictCode: 'EXTERNAL', dictLabel: '外部工厂', sort: 2 },
      ],
      review_status: [
        { dictType: 'review_status', dictCode: 'PASS', dictLabel: '通过', sort: 1 },
        { dictType: 'review_status', dictCode: 'REWORK', dictLabel: '需修改', sort: 2 },
        { dictType: 'review_status', dictCode: 'REJECT', dictLabel: '不通过', sort: 3 },
      ],
      secondary_process_status: [
        { dictType: 'secondary_process_status', dictCode: 'PENDING', dictLabel: '待处理', sort: 1 },
        { dictType: 'secondary_process_status', dictCode: 'PROCESSING', dictLabel: '处理中', sort: 2 },
        { dictType: 'secondary_process_status', dictCode: 'COMPLETED', dictLabel: '已完成', sort: 3 },
        { dictType: 'secondary_process_status', dictCode: 'CANCELLED', dictLabel: '已取消', sort: 4 },
      ],
      employment_status: [
        { dictType: 'employment_status', dictCode: 'NORMAL_STATUS', dictLabel: '正式', sort: 1 },
        { dictType: 'employment_status', dictCode: 'PROBATION', dictLabel: '试用期', sort: 2 },
        { dictType: 'employment_status', dictCode: 'TEMPORARY', dictLabel: '临时工', sort: 3 },
      ],
      order_type: [
        { dictType: 'order_type', dictCode: 'FIRST', dictLabel: '首单', sort: 1 },
        { dictType: 'order_type', dictCode: 'REORDER', dictLabel: '翻单', sort: 2 },
      ],
      order_biz_type: [
        { dictType: 'order_biz_type', dictCode: 'FOB', dictLabel: 'FOB', sort: 1 },
        { dictType: 'order_biz_type', dictCode: 'ODM', dictLabel: 'ODM', sort: 2 },
        { dictType: 'order_biz_type', dictCode: 'OEM', dictLabel: 'OEM', sort: 3 },
        { dictType: 'order_biz_type', dictCode: 'CMT', dictLabel: 'CMT', sort: 4 },
      ],
      outbound_type: [
        { dictType: 'outbound_type', dictCode: 'SALES', dictLabel: '销售出库', sort: 1 },
        { dictType: 'outbound_type', dictCode: 'TRANSFER', dictLabel: '调拨出库', sort: 2 },
        { dictType: 'outbound_type', dictCode: 'SCRAP', dictLabel: '报废出库', sort: 3 },
      ],
      template_type: [
        { dictType: 'template_type', dictCode: 'PROCESS', dictLabel: '工序进度单价', sort: 1 },
        { dictType: 'template_type', dictCode: 'PROCESS_SIZE', dictLabel: '多码工序进度单价', sort: 2 },
      ],
    };
