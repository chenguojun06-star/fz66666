...
export const APP_TYPE_CONFIG: Record<string, { label: string; color: string; icon: string; description: string }> = {
  ...
  EC_TMALL:         { label: '天猫对接',       color: 'var(--color-red-500)',              icon: '', description: '天猫旗舰店订单实时同步，支持SKU映射' },
  ...
  EC_PINDUODUO:     { label: '拼多多对接',     color: 'var(--color-red-600)',              icon: '', description: '拼多多平台订单同步，支持多规格SKU' },
