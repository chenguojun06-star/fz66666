    ...
    "sizes": ["S", "M", "L"]
      ...
      <Card title={<span><SwapOutlined style={{ marginRight: 8, color: 'var(--color-info)' }} />四大对接模块</span>} style={{ marginBottom: 24 }}>
        <Row gutter={[16, 16]}>
          ...
          <Col xs={24} sm={12}>
            <FlowCard icon={<CheckCircleOutlined />} title="✅ 质检反馈 (QUALITY_FEEDBACK)" desc="入库质检完成 → 自动Webhook推送质检结果到客户系统。支持API主动查询质检报告。" color="#52c41a" />
          </Col>
          <Col xs={24} sm={12}>
      ...
      <Card title={<span><TeamOutlined style={{ marginRight: 8, color: 'var(--color-info)' }} />多应用管理 — 一个账号对接多个ERP系统</span>} style={{ marginBottom: 24 }}>
        ...
        <div style={{ background: 'rgba(234, 179, 8, 0.15)', padding: 16, borderRadius: 8, borderLeft: '4px solid #faad14', marginTop: 16 }}>
