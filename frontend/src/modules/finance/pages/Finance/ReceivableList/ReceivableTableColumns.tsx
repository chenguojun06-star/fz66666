...
interface GetColumnsOptions {
  ...
  onReceive: (record: Receivable) => void;
}

const getReceivableColumns = (options: GetColumnsOptions): ColumnsType<Receivable> => {
  const { openReceivableDetail, goToMaterialPickup, handleDelete, onReceive } = options;
...
export default getReceivableColumns;
