...
import {
  ...
  Select, Space, Table, Tag, Tooltip, Popconfirm, Row, Col, Statistic,
} from 'antd';
import {
    ...
    <Layout>
      <div style={{ padding: '0 0 24px' }}>
        ...
        <Row gutter={16} style={{ marginBottom: 16 }}>
          <Col span={8}>
            <Card size="small"><Statistic title="待审批" value={stats.pending} suffix="件" valueStyle={{ color: 'var(--color-warning)' }} /></Card>
          </Col>
          <Col span={8}>
            <Card size="small"><Statistic title="本页总金额" value={stats.totalAmount} prefix="¥" precision={2} /></Card>
          </Col>
          <Col span={8}>
            <Card size="small"><Statistic title="已付款金额" value={stats.paidAmount} prefix="¥" precision={2} valueStyle={{ color: 'var(--color-success)' }} /></Card>
          </Col>
        </Row>
