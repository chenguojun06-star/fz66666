                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                  {patrolSummary.highRiskPending > 0 && (
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                        <Tag color="red" style={{ margin: 0 }}>楂橀闄?/Tag>
                        <span style={{ fontSize: 13 }}><b>{patrolSummary.highRiskPending}</b> 涓珮椋庨櫓椤瑰緟澶勭悊</span>
                      </div>
                      <span style={{ fontSize: 12, color: '#999' }}>鏌ョ湅 鈫?/span>
                    </div>
                  )}
                  {patrolSummary.pendingCount > 0 && (
                    <div
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                        <Tag color="orange" style={{ margin: 0 }}>寰呭鐞?/Tag>
                        <span style={{ fontSize: 13 }}>鍏?<b>{patrolSummary.pendingCount}</b> 涓贰妫€椤?/span>
                      </div>
                      <span style={{ fontSize: 12, color: '#999' }}>鏌ョ湅 鈫?/span>
                    </div>
                  )}
                  {patrolSummary.autoExecutedToday > 0 && (
                    <div style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '4px 10px' }}>
                      <Tag color="green" style={{ margin: 0 }}>宸叉墽琛?/Tag>
                      <span style={{ fontSize: 13, color: '#555' }}>浠婃棩AI宸茶嚜鍔ㄥ鐞?<b>{patrolSummary.autoExecutedToday}</b> 椤逛换鍔?/span>
                    </div>
                  )}
                  {patrolSummary.recentActions && patrolSummary.recentActions.length > 0 && (
                    <div style={{ borderTop: '1px solid #f0f0f0', paddingTop: 8, marginTop: 4 }}>
                      <div style={{ fontSize: 12, color: '#999', marginBottom: 6 }}>鏈€杩戝贰妫€鍙戠幇</div>
