...
const BottleneckPanel: React.FC<BottleneckPanelProps> = ({
  ...
  return (
    <div className="c-card c-hover-hl">
      <div className="c-card-title u-cur-pointer"  onClick={() => toggleCollapse('bottleneck')}>
        ...
        <span className="u-fs-14" style={{ color: 'var(--color-blue-400)', letterSpacing: 0 }}>点击整行或订单号可直达 →</span>
