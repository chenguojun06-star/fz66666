    ...
    <div className="c-stage-capsule-panel">
      <div className="c-card c-stage-shell">
        <div className="c-card-title u-cur-pointer"  onClick={toggleCollapsed}>
          ...
          <span
            style={{ marginLeft: 'auto', cursor: 'pointer', color: collapsed ? STAGE_ACCENT : STAGE_ACCENT, fontSize: 15, padding: '0 4px', display: 'inline-flex', alignItems: 'center', flexShrink: 0, userSelect: 'none' }}
