...
const DEFAULT_AGENTS: AgentInfo[] = [
  ...
  { id: 'sourcing-specialist', name: '采购专家', department: 'intelligence', color: 'var(--color-teal-700)', description: '物料清单成本分析、供应商交付评估、物料缺口识别', status: 'idle', lastActivity: null, tasksToday: 0, successRate: 100, avgDurationMs: 0, intelligenceScore: 50, lazinessScore: 0, currentTask: null, position: { x: 0, y: 0 } },
