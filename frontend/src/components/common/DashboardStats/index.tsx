 ...
 *   columns={4}
 *   stats={[
 *     { title: '总订单', value: 1250, suffix: '个', valueColor: '#1890ff' },
 *     { title: '总金额', value: 156800, prefix: '¥', precision: 2, valueColor: '#52c41a' },
 *     { title: '待处理', value: 23, suffix: '个', valueColor: '#faad14' },
 *     { title: '已完成', value: 1227, suffix: '个', valueColor: '#52c41a' },
 *   ]}
 * />
 * ```
 */
