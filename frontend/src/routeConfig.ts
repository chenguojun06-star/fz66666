...
export const paths = {
  ...
  combinedProduct: '/warehouse/combined-product',
...
export const permissionCodes = {
  ...
  combinedProduct: 'MENU_COMBINED_PRODUCT',
...
export const menuConfig: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: '资料维护', path: paths.maintenanceCenter, icon: React.createElement(DatabaseOutlined) },
  ...
  },
  {
    ...
    items: [
      { label: '商品仓储', path: paths.finishedInventory, icon: React.createElement(InboxOutlined) },
      { label: '组合商品', path: paths.combinedProduct, icon: React.createElement(DeploymentUnitOutlined) },
      { label: '商品资料', path: paths.productInfo, icon: React.createElement(ProfileOutlined) },
...
export const routeToPermissionCode: Record<string, string> = {
  ...
  [paths.combinedProduct]: permissionCodes.combinedProduct,
