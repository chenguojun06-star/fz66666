...
> **系统评分**：98/100 | **代码质量**：优秀 | **架构**：非标准分层设计（235个编排器：105业务+130AI）| **规模**：429k行代码
> **测试覆盖率**：⚠️ 测试源码已丢失（仅存编译类），需重建测试体系
...
- **完整开发规范**：CLAUDE.md - 完整开发规范与最佳实践
- **设计系统**：设计系统完整规范-2026.md - 强制执行的设计规范
- **业务流程**：系统状态.md - 理解业务逻辑
- **测试脚本**：README.md - 测试脚本说明
