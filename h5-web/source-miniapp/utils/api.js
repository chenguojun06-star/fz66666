...
const { employeeAdvance, factoryShipment, wagePayment, payrollSettlement, wageSettlementFeedback, materialReconciliation, expenseReimbursement } = require('./api-modules/finance');
const ecommerce = require('./api-modules/ecommerce');
const { collaboration } = require('./api-modules/collaboration');
...
module.exports.materialReconciliation = materialReconciliation;
module.exports.expenseReimbursement = expenseReimbursement;
