/**
 * H5-独立端统一验证规则库
 * 与小程序 miniprogram/utils/validationRules.js 保持一致（CommonJS → ESM 转换）
 * P0-4 修复（D-023）：补齐业务校验规则，与小程序/PC端三端对齐
 */
...
/**
 * 批量校验字段（数组形式规则）
 * 兼容 H5-独立端原版用法，避免破坏现有调用方
 * @param {Array} rules - 规则数组：[{ value, message, validator }]
 * @param {boolean} showToast - 是否提示（H5-独立端原版仅 console.warn）
