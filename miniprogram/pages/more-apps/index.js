...
const ALL_APPS = [
  ...
  { group: '生产模块', items: [
    ...
    { id: 'cuttingTask', name: '裁剪任务', iconClass: 'icon-menu-cutting', circleClass: 'menu-icon-circle--rose', route: '/pages/cutting/bundle-detail/index' },
    ...
    { id: 'returnManage', name: '退货管理', iconClass: 'icon-menu-shipment', circleClass: 'menu-icon-circle--red', route: '/pages/return/list/index' },
