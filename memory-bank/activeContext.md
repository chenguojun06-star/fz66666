...
> 最后更新：2026-08-25（D-127~D-131 财务链路P0修复包）

---

## 最近变更（Latest Changes）

### 2026-08-25 ★★★ D-127~D-131 财务链路P0修复包 ✅tsc/mvn/flyway 全过待部署
...
### 2026-08-25 ★ 财务四链路审查完成（P0 已落地，P1 待做）

- [x] 四链路高严重度 13 项已核实（详见 D-127~D-131 决策记录）；P1 遗留：外发"出货对账单 vs 成品结算"双轨并存（重复付款风险，需二选一下线）、对账去重键靠 remark LIKE、工资结算单列表 UI 缺失（状态机对用户不可见）
- [ ] P1 待用户排期
