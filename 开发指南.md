...
| **🟡 中级权限** | FINANCE_SEWING_PRICE_ONLY | workshop_director | 只能看车缝单价和车缝金额 |
| **🟢 基础权限** | FINANCE_BASIC_DATA_ONLY | cutter, sewing, quality, packager | 只能看订单号、数量、进度（无单价） |
