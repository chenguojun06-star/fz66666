...
FROM (
    ...
    UNION ALL SELECT 't_material_pickup_record', 'tenant_id'
    UNION ALL SELECT 't_material_pickup_record', 'pickup_no'
    UNION ALL SELECT 't_material_pickup_record', 'pickup_type'
    UNION ALL SELECT 't_material_pickup_record', 'order_no'
    UNION ALL SELECT 't_material_pickup_record', 'style_no'
    UNION ALL SELECT 't_material_pickup_record', 'material_id'
    UNION ALL SELECT 't_material_pickup_record', 'material_code'
    UNION ALL SELECT 't_material_pickup_record', 'material_name'
    UNION ALL SELECT 't_material_pickup_record', 'material_type'
    UNION ALL SELECT 't_material_pickup_record', 'color'
    UNION ALL SELECT 't_material_pickup_record', 'specification'
    ...
    UNION ALL SELECT 't_material_pickup_record', 'quantity'
    UNION ALL SELECT 't_material_pickup_record', 'unit'
    UNION ALL SELECT 't_material_pickup_record', 'unit_price'
    UNION ALL SELECT 't_material_pickup_record', 'amount'
    UNION ALL SELECT 't_material_pickup_record', 'picker_id'
    UNION ALL SELECT 't_material_pickup_record', 'picker_name'
    UNION ALL SELECT 't_material_pickup_record', 'pickup_time'
    UNION ALL SELECT 't_material_pickup_record', 'audit_status'
    UNION ALL SELECT 't_material_pickup_record', 'auditor_id'
    UNION ALL SELECT 't_material_pickup_record', 'auditor_name'
    UNION ALL SELECT 't_material_pickup_record', 'audit_time'
    UNION ALL SELECT 't_material_pickup_record', 'audit_remark'
    UNION ALL SELECT 't_material_pickup_record', 'finance_status'
    UNION ALL SELECT 't_material_pickup_record', 'finance_remark'
    UNION ALL SELECT 't_material_pickup_record', 'remark'
    UNION ALL SELECT 't_material_pickup_record', 'create_time'
    UNION ALL SELECT 't_material_pickup_record', 'update_time'
    UNION ALL SELECT 't_material_pickup_record', 'delete_flag'
    UNION ALL SELECT 't_agent_meeting', 'tenant_id'
    UNION ALL SELECT 't_agent_meeting', 'meeting_type'
    UNION ALL SELECT 't_agent_meeting', 'topic'
    UNION ALL SELECT 't_agent_meeting', 'participants'
    UNION ALL SELECT 't_agent_meeting', 'agenda'
    UNION ALL SELECT 't_agent_meeting', 'debate_rounds'
    UNION ALL SELECT 't_agent_meeting', 'consensus'
    UNION ALL SELECT 't_agent_meeting', 'dissent'
    UNION ALL SELECT 't_agent_meeting', 'action_items'
    UNION ALL SELECT 't_agent_meeting', 'confidence_score'
    UNION ALL SELECT 't_agent_meeting', 'linked_decision_ids'
    UNION ALL SELECT 't_agent_meeting', 'linked_rca_ids'
    UNION ALL SELECT 't_agent_meeting', 'duration_ms'
    UNION ALL SELECT 't_agent_meeting', 'status'
    UNION ALL SELECT 't_agent_meeting', 'delete_flag'
    UNION ALL SELECT 't_agent_meeting', 'create_time'
