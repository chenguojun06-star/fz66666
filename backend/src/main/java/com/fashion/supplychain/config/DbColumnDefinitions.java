...
public final class DbColumnDefinitions {
    ...
    private static void addStyleColumns() {
        ...
        add("t_style_info", "image_insight", "TEXT DEFAULT NULL COMMENT 'AI图片洞察'");
        add("t_style_info", "vision_raw", "TEXT DEFAULT NULL COMMENT 'Agnes视觉模型原始分析结果'");
    ...
    private static void addFactoryColumns() {
        ...
        add("t_factory", "manager_id", "VARCHAR(64) DEFAULT NULL COMMENT '领取人ID'");
        add("t_factory", "manager_name", "VARCHAR(100) DEFAULT NULL COMMENT '领取人姓名'");
    ...
    private static void addOtherColumns() {
        ...
        add("t_production_order", "urge_count", "INT NOT NULL DEFAULT 0 COMMENT '催单次数'");
        add("t_production_order", "last_urge_time", "DATETIME DEFAULT NULL COMMENT '最后催单时间'");
        add("t_sys_notice", "urge_record_id", "VARCHAR(64) DEFAULT NULL COMMENT '关联催单记录ID'");
        add("t_sys_notice", "action_type", "VARCHAR(32) DEFAULT NULL COMMENT '操作类型'");
        add("t_urge_record", "id", "VARCHAR(64) NOT NULL COMMENT '主键'");
        add("t_urge_record", "tenant_id", "BIGINT NOT NULL COMMENT '租户ID'");
        add("t_urge_record", "order_id", "VARCHAR(64) NOT NULL COMMENT '生产订单ID'");
        add("t_urge_record", "order_no", "VARCHAR(64) NOT NULL COMMENT '订单号'");
        add("t_urge_record", "sender_name", "VARCHAR(100) DEFAULT NULL COMMENT '催单人姓名'");
        add("t_urge_record", "receiver_name", "VARCHAR(100) DEFAULT NULL COMMENT '被催人姓名'");
        add("t_urge_record", "remark", "VARCHAR(500) DEFAULT NULL COMMENT '催单备注'");
        add("t_urge_record", "status", "VARCHAR(20) NOT NULL DEFAULT 'pending' COMMENT '状态'");
        add("t_urge_record", "reply_content", "VARCHAR(500) DEFAULT NULL COMMENT '回复内容'");
        add("t_urge_record", "reply_expected_ship_date", "DATETIME DEFAULT NULL COMMENT '回复的预计出货日期'");
        add("t_urge_record", "reply_time", "DATETIME DEFAULT NULL COMMENT '回复时间'");
        add("t_urge_record", "created_at", "DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '催单时间'");
