...
public class TenantOrchestrator {
    ...
    public Page<User> listSubAccounts(Long page, Long pageSize, String name, String roleName, String orgUnitId, String employmentStatus, String roleId, String employeeNo, Boolean excludeFactoryUsers) { return subAccountHelper.listSubAccounts(page, pageSize, name, roleName, orgUnitId, employmentStatus, roleId, employeeNo, excludeFactoryUsers); }
