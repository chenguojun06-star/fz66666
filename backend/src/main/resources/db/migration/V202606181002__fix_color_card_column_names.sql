...
SET @s = IF(
    ...
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS
     WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 't_color_card' AND COLUMN_NAME = 'fabric_width')
);
PREPARE stmt FROM @s;
EXECUTE stmt;
...
SET @s = IF(
    ...
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS
     WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 't_color_card' AND COLUMN_NAME = 'fabric_weight')
);
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @s = IF(
    ...
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS
     WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 't_color_card' AND COLUMN_NAME = 'fabric_composition')
);
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
