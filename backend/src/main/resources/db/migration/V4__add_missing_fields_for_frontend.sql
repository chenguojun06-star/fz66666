...
DROP PROCEDURE IF EXISTS `__mig_V4__add_missing_fields_for_frontend`;
DELIMITER $$
CREATE PROCEDURE `__mig_V4__add_missing_fields_for_frontend`()
BEGIN
...
END$$
DELIMITER ;
CALL `__mig_V4__add_missing_fields_for_frontend`();
DROP PROCEDURE IF EXISTS `__mig_V4__add_missing_fields_for_frontend`;
