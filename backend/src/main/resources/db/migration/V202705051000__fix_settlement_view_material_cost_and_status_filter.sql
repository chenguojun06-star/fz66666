-- V202705051000: 修复 v_finished_product_settlement 视图面辅料成本计算
-- 问题1: mat 子查询缺少 delete_flag=0 过滤，已软删除的采购单也被统计
-- 问题2: mat 子查询只统计 RECEIVED/COMPLETED 状态，外发厂采购单停留在 pending 不被统计
-- 问题3: 视图原逻辑未排除 scrapped/archived 状态（已报废/已归档的订单不应出现在结算中）
