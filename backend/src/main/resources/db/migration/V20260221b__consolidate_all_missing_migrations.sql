...
DROP PROCEDURE IF EXISTS `__mig_V20260221b__consolidate_all_missing_migrations`;
DELIMITER $$
CREATE PROCEDURE `__mig_V20260221b__consolidate_all_missing_migrations`()
BEGIN
    ...
    CREATE INDEX `idx_created_by_id` ON `t_production_order` (`created_by_id`);
    ...
    CREATE INDEX `idx_order_transfer_tenant_type`
...
END$$
DELIMITER ;
CALL `__mig_V20260221b__consolidate_all_missing_migrations`();
DROP PROCEDURE IF EXISTS `__mig_V20260221b__consolidate_all_missing_migrations`;
