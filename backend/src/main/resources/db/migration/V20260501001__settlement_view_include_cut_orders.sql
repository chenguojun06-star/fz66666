-- ======================================================================
-- V20260501001: 成品结算视图包含 CUT 裁剪订单
-- 问题：v_finished_product_settlement 视图有 AND po.order_no NOT LIKE 'CUT%'
--       导致所有裁剪单（CUT开头）被排除在成品结算/工资汇总的订单汇总之外。
-- 修复：移除 CUT 排除条件，裁剪单与普通订单统一处理。
-- ======================================================================
