...
-- 防御策略: 动态 SQL + 前置列存在性检查，避免因列缺失导致 Flyway 迁移反复失败
-- ============================================================
