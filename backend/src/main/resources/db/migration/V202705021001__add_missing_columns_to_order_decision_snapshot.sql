...
SET @s = IF(@col_exists = 0, 'ALTER TABLE t_order_decision_snapshot ADD COLUMN decision_type VARCHAR(32) DEFAULT NULL', 'SELECT 1');
PREPARE stmt FROM @s;
EXECUTE stmt;
...
SET @s = IF(@col_exists = 0, 'ALTER TABLE t_order_decision_snapshot ADD COLUMN decision_data JSON DEFAULT NULL', 'SELECT 1');
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @s = IF(@col_exists = 0, 'ALTER TABLE t_order_decision_snapshot ADD COLUMN ai_suggestion TEXT DEFAULT NULL', 'SELECT 1');
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @s = IF(@col_exists = 0, 'ALTER TABLE t_order_decision_snapshot ADD COLUMN ai_confidence DECIMAL(5,2) DEFAULT NULL', 'SELECT 1');
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @s = IF(@col_exists = 0, 'ALTER TABLE t_order_decision_snapshot ADD COLUMN user_choice VARCHAR(32) DEFAULT NULL', 'SELECT 1');
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @s = IF(@col_exists = 0, 'ALTER TABLE t_order_decision_snapshot ADD COLUMN user_modified_fields JSON DEFAULT NULL', 'SELECT 1');
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
