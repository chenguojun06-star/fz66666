...
DROP PROCEDURE IF EXISTS `__mig_V2026022602__fix_process_tracking_id_types`;
DELIMITER $$
CREATE PROCEDURE `__mig_V2026022602__fix_process_tracking_id_types`()
BEGIN
...
END$$
DELIMITER ;
CALL `__mig_V2026022602__fix_process_tracking_id_types`();
DROP PROCEDURE IF EXISTS `__mig_V2026022602__fix_process_tracking_id_types`;
