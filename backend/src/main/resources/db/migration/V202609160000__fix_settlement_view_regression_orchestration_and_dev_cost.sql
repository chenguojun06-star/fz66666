-- ======================================================================
-- V202609160000: 修复成品结算视图回归问题
-- 问题1: scan 子查询缺少 scan_type != 'orchestration' 过滤，导致生产成本虚高
--   （V20260423004 已修复，但 V202609021000 重建视图时丢失了该条件）
-- 问题2: 缺少 dev_cost_price 列，导致前端"开发单价"列始终为0
--   （V20260423004 有该列，V202609021000 重建时遗漏）
-- 问题3: scan 子查询缺少 factory_id IS NULL 过滤，外发工厂扫码成本不应计入内部生产成本
-- 问题4: 缺少 factory_type/parent_org_unit_id/parent_org_unit_name/org_path 列
--   （FinishedProductSettlement 实体有这些 @TableField(exist=false) 字段）
-- ======================================================================
