...
DROP PROCEDURE IF EXISTS `__mig_V20260205__add_order_management_fields`;
DELIMITER $$
CREATE PROCEDURE `__mig_V20260205__add_order_management_fields`()
BEGIN
...
END$$
DELIMITER ;
CALL `__mig_V20260205__add_order_management_fields`();
DROP PROCEDURE IF EXISTS `__mig_V20260205__add_order_management_fields`;
