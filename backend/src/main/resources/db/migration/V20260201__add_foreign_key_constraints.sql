...
DROP PROCEDURE IF EXISTS `__mig_V20260201__add_foreign_key_constraints`;
DELIMITER $$
CREATE PROCEDURE `__mig_V20260201__add_foreign_key_constraints`()
BEGIN
...
END$$
DELIMITER ;
CALL `__mig_V20260201__add_foreign_key_constraints`();
DROP PROCEDURE IF EXISTS `__mig_V20260201__add_foreign_key_constraints`;
